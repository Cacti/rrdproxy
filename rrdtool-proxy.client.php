							...
							if (substr($input, -1) == "\n") {
								...
								if( in_array($cmd, $rrdtool_cmds) === true ) {
									...
									if($rrdtool_process === false) {
										$rrdtool_process_pipes	= rrdtool_pipe_init();
